class Settings:
    def __init__(self):
        ...
        # Гены
        self.mut_ratio = 0.15  # Сила симуляции
        # Энергия
        ...
        self.chloroplast_energy = 0.105 # Энергия получаемая фотосинтезом
        # Ограничения
        ...
        self.max_agents = 100 # Максимальное кол-во агентов на поле
        self.min_herbivory = -1
        self.max_herbivory = 1
        self.min_carnivorous = -1
        self.max_carnivorous = 1
        self.min_chloroplast = -1
        self.max_chloroplast = 1
        # Цвета
